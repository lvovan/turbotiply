...
**Feature Branch**: `001-player-sessions`
**Created**: 2026-02-14
**Status**: Draft
...
- **SC-003**: 95% of children aged 6–12 can complete the player-selection flow without adult assistance on first attempt.
...
- **SC-006**: The welcome screen and player list are fully usable on a 320px-wide phone screen and a 1920px-wide desktop screen.
...
- The app does not need to sync player data across devices. Each device maintains its own independent player list (per constitution v1.1.0).
