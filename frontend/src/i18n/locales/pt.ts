...
const pt: Dictionary = {
  ...
  'game.instructions': 'Responda 10 perguntas de multiplicação o mais rápido que puder!',
  ...
  'mode.improveDescription': 'Treine seus números difíceis: {numbers}',
  'mode.improveAriaLabel': 'Melhorar — Treine seus números difíceis: {numbers}',
  'mode.encouragement': 'Nenhum número difícil por enquanto — continue jogando para desbloquear o modo Melhorar!',
  ...
  'a11y.formulaWithAnswer': 'Fórmula de multiplicação: {a} vezes {b} é igual a {c}. Sua resposta foi {answer}.',
  'a11y.formulaWithoutAnswer': 'Fórmula de multiplicação: {a} vezes {b} é igual a {c}. Encontre o valor que falta.',
} as const;
