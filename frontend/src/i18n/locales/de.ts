...
const de: Dictionary = {
  ...
  'mode.improveDescription': 'Übe deine schwierigen Zahlen: {numbers}',
  'mode.improveAriaLabel': 'Verbessern — Übe deine schwierigen Zahlen: {numbers}',
  'mode.encouragement': 'Keine schwierigen Zahlen gerade — spiel weiter, um den Verbesserungsmodus freizuschalten!',
